...
from models.flow.flowplusplus import log_dist as logistic
from models.flow.flowplusplus.nn import NN
...
class Coupling(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, num_blocks, num_components, drop_prob,
        ...
        self.use_logistic = num_components > 0
