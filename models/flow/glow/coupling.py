...
class Coupling(nn.Module):
    ...
    Note: The official Glow implementation (https://github.com/openai/arch)
...
class NN(nn.Module):
    ...
    Args:
        ...
        use_actnorm (bool): Use activation norm rather than batch norm.
    """
    def __init__(self, in_channels, mid_channels, out_channels, use_actnorm=False):
        super(NN, self).__init__()
        norm_fn = ActNorm if use_actnorm else nn.BatchNorm2d
